...
define_hls_config SobelFilter DPAUNROLL	-DUNROLL1 --dpopt_auto=op,expr
define_hls_config SobelFilter DPAPIPE		-DPIPELINE1 --dpopt_auto=op,expr

define_hls_config SobelFilter DPAUP		-DPIPELINE1 -DUNROLL1 --dpopt_auto=op,expr
